...
local jokerIndexList = {3,2,5,7,8,4,6,1}
...
local consumableIndexList = {2,5,1,4,3}
...
SMODS.ObjectType({
    key = "test_test_jokers",
    cards = {
        ["j_test__404testing"] = true,
        ["j_test_filescorrupt3d"] = true
    },
})

SMODS.ObjectType({
    key = "test_mycustom_jokers",
    cards = {
        ["j_test__5credmullllllllllllllt"] = true,
        ["j_test_+5chips"] = true,
        ["j_test_cracks"] = true
    },
})
...
SMODS.ObjectType({
    key = "test_RGB",
    cards = {
        ["j_test_credcgreencblue"] = true,
        ["j_test_rgb"] = true,
        ["j_test_rgreeeeeeenandcblue"] = true
    },
})
